...
- **Republic of Korea Air Force — AI & New Technology Systems Development Unit** (2025.10 – 2026.11)  
  Competitively selected through internal application and interview process for transfer to the AI신기술체계개발대, 공군지능정보체계관리단.  
  Led development of two core pipelines:
  - **Airwards Image Search Pipeline**: RAG-based aerial image search service using OpenSearch (BGE-M3 neural search), vLLM, MinIO, and Airflow. Built image captioning pipeline with Gemma/Qwen models and implemented hybrid keyword + kNN search.
  - **RAG Evaluation Pipeline**: Designed and implemented evaluation framework using RAGAS, DeepEval (custom G-Eval metrics), and RAGChecker with Qwen3-32B as judge model via Langfuse.

- **Republic of Korea Air Force — Signal Corps** (2025.02 – 2025.10)  
  Served as signal/communication technical enlisted member with focus on operational support.
